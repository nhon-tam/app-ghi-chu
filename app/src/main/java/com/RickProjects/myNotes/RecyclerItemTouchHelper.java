...
import com.RickProjects.myNotes.activities.TodoActivity;
...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public RecyclerItemTouchHelper(ToDoAdapter adapter, ToDoViewModel mTodoViewModel, TodoActivity activity) {
    ...
    public void onSwiped(@NonNull final RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (direction == ItemTouchHelper.LEFT) {
            ...
            builder.setPositiveButton("Confirm",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            mTodoViewModel.delete(adapter.getTodoAt(position));
                        }
                    });
            ...
            Todo item = adapter.getTodoAt(position);
            Bundle bundle = new Bundle();
            bundle.putInt("id", item.getId());
            bundle.putString("task", item.getTask());
            AddNewTask fragment = new AddNewTask(this.mTodoViewModel);
